...
<section class="content">
    <div class="">
        ...
        <div class="container-fluid">
            <form  action="{{route('adminSaveRole')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row" >
                <div class="col-lg-6 col-md-12">
                    <label for="Role Name">Role Name<span class="text-danger">*</span></label>
                    <div class="form-group">                                
                        <input type="text" id="role_name" name="role_name" class="form-control" placeholder="Role Name" value="{{old('role_name')}}" required>
                    </div>

            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('adminAddCategory')}}"> Add Category</a></li>
            ...
            <form  action="{{route('adminUpdateCategory')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="form-group">                                
                        <input type="hidden" id="id" name="id" class="form-control" placeholder="Category Name" value="{{$category->id}}" required>
